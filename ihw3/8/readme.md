...
Header-файл, содержащий необходимые для работы приложения объявления функций - [echoServer.h](echoServer.h)

Реализации функций, приведенных в `echoServer.h` - [handleClient.cpp](handleClient.cpp)
